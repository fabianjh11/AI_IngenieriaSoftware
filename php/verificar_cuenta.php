<?php
	...
	$consulta = "select * from restaurante.usuario where correo='$correo' and estado='0'";
	$update = "update restaurante.usuario set estado='1' where correo='$correo'";

	$resultado = pg_query($conexion,$consulta);
	if($filas = pg_num_rows($resultado)==0)
	{
		header("Location: ../html/datos_incorrectos_admin.html");
		exit();
	}
