...
<html>
	...
	<body>
		<nav class="Menu">
			<ul>
				<li>
					<div class="Home" onclick="location.href='gerente.php'">
						<div class="Logo">
		...
		<div class="Seccion">
			<h2 class="Frase">Bienvenido GERENTE</h2>
		</div>

		<div class="Medio">
			<button class="Contenido" onclick="location.href='reservacion.php'">Reservar</button>
			<button class="Contenido" onclick="location.href='gestion_reserva.php'">Gestionar Reservas</button>
			<button class="Contenido" onclick="location.href='comentarios.php'">Comentarios</button>
		</div>
